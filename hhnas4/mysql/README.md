...
Shared MySQL 8 stack for internal services on `hhnas4`.
...
```text
/volume1/docker/homelab/hhnas4/mysql
```
...
```bash
./deploy.sh hhnas4.internal.example /volume1/docker/homelab/hhnas4/mysql
```
