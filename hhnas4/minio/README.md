...
Shared S3-compatible object storage service for internal workloads on `hhnas4`.
...
- `minio.<internal-domain> -> <hhnas4-lan-reachable-address>`
...
```text
/volume1/docker/homelab/hhnas4/minio
```
...
```bash
./deploy.sh hhnas4.internal.example /volume1/docker/homelab/hhnas4/minio
```
