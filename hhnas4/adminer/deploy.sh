...
Examples:
  ./deploy.sh nas-host
  ./deploy.sh nas-host /volume1/docker/homelab/nas-host/adminer
  ./deploy.sh nas-host --update-env
USAGE
}

TARGET_HOST="nas-host.internal.example"
TARGET_DIR="/volume1/docker/homelab/nas-host/adminer"
...
echo "[deploy] ensuring Docker network ${SHARED_DB_NETWORK} exists"
...
echo "[deploy] adminer deployed. Verify with:"
...
echo "         curl -sk http://adminer.internal.example:${ADMINER_PORT:-8080}/ || true"
