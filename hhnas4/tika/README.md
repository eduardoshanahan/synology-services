...
Shared text and metadata extraction service for internal services on `hhnas4`.
...
- `tika.internal.example -> <hhnas4-lan-ip>`
...
```text
/volume1/docker/homelab/hhnas4/tika
```
...
```bash
./deploy.sh hhnas4.internal.example /volume1/docker/homelab/hhnas4/tika
```
