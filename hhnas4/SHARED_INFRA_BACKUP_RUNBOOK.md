...
```bash
/bin/bash /volume1/docker/homelab/nas-host/backup-shared-infra.sh nas-host /volume1/docker/homelab/nas-host --retention-days 21 >> /volume1/docker/homelab/nas-host/backups/shared-infra/backup.log 2>&1
```
