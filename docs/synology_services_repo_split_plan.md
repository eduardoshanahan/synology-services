...
Current runtime paths on `nas-host`:

- `/volume1/docker/homelab/nas-host/gitea/compose.yaml`
- `/volume1/docker/homelab/nas-host/gitea/.env`
- `/volume1/docker/homelab/nas-host/gitea/data`
- `/volume1/docker/homelab/nas-host/promtail/compose.yaml`
- `/volume1/docker/homelab/nas-host/promtail/.env`
- `/volume1/docker/homelab/nas-host/promtail/config.yml`

Do not change these paths during the repository split.

## Why This Works

`nas-host/deploy.sh` resolves source files relative to the script location:
...
1. `cd synology-services/nas-host`
