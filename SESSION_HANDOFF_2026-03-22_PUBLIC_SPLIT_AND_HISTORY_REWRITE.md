...
- `hhnas4/mongo/deploy.sh`
- `hhnas4/postgres/deploy.sh`
- `hhnas4/redis/deploy.sh`
- `hhnas4/tika/deploy.sh`
- `hhnas4/gotenberg/deploy.sh`
- `hhnas4/dolt/deploy.sh`
- `hhnas4/karakeep/deploy.sh`
- `hhnas4/paperless/deploy.sh`
- `hhnas4/outline/deploy.sh`
- `hhnas4/jellyfin/deploy.sh`
- `hhnas4/qbittorrent/deploy.sh`
- `hhnas4/mysql/deploy.sh`
- `hhnas4/woodpecker-agent/deploy.sh`
- `hhnas4/gitea-deploy.sh`

Additional alignment:

- `hhnas4/mysql/deploy.sh` now supports `--update-env`
- `hhnas4/woodpecker-agent/deploy.sh` now supports `--update-env`
- `hhnas4/gitea-deploy.sh` now supports `--update-env`
...
- `hhnas4/dolt/.env.sops`
- `hhnas4/jellyfin/.env.sops`
- `hhnas4/karakeep/.env.sops`
- `hhnas4/mongo/.env.sops`
- `hhnas4/mysql/.env.sops`
- `hhnas4/outline/.env.sops`
- `hhnas4/paperless/.env.sops`
- `hhnas4/postgres/.env.sops`
- `hhnas4/qbittorrent/.env.sops`
- `hhnas4/redis/.env.sops`
- `hhnas4/woodpecker-agent/.env.sops`
...
- `synology-services-private/hhnas4/dolt/.env`
...
- `synology-services-private/hhnas4/dolt/.env` still exists as plaintext and
...
- public tree scan confirmed no remaining local `.env` or `.env.sops` files
  under `synology-services/hhnas4`
...
- public repo `find hhnas4 -maxdepth 2 \( -name '.env.sops' -o -name '.env' \)`
  returns nothing
...
- `synology-services-private/hhnas4/dolt/.env` was present as a temporary
  migration artifact.
- it matched the decrypted `.env.sops` content after normalizing blank lines
  and has now been removed
- the public deploy flow still resolves `hhnas4/dolt/.env.sops` correctly via
...
```bash
find hhnas4 -maxdepth 2 \( -name '.env.sops' -o -name '.env' \) | sort
```
